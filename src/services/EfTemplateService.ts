...
const FIN_DIC_CODE_COLUMN: Record<string, string> = {
...
export function isSupportedTemplateType(typeCode: string): boolean {
  return SUPPORTED_TEMPLATE_TYPES.has(typeCode.toUpperCase());
}

function workbookToBuffer(workbook: XLSX.WorkBook, bookType: XLSX.BookType): Buffer {
  return Buffer.from(
...
function generateCemInitialTemplate(): EfTemplateResult {
  const headers = [
    'Student_ID',
    'Class',
    'Name',
...
function generateCemFinalTemplate(): EfTemplateResult {
  const headers = [
    'Student_ID',
    'Class',
    'Surname',
...
function generateHrEmployeeDataTemplate(): EfTemplateResult {
  const headers = [
    'Year',
    'Quarter',
    'Month',
...
function generateHrBudgetVsActualTemplate(): EfTemplateResult {
...
function generateFinanceDictionaryTemplate(typeCode: string): EfTemplateResult {
...
function generateFinanceTrialBalanceTemplate(typeCode: string): EfTemplateResult {
 ...
 */
export function generateEfTemplate(typeCode: string): EfTemplateResult {
