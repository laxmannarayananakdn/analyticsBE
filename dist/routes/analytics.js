 ...
 */
router.get('/student-vs-class-average', async (req, res) => {
    try {
 ...
 */
router.get('/performance-by-program', async (req, res) => {
    try {
 ...
 */
router.get('/attendance-by-grade', async (req, res) => {
    try {
 ...
 */
router.get('/financial-aid-distribution', async (req, res) => {
    try {
