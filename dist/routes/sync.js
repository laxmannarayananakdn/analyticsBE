...
router.post('/schedules', async (req, res) => {
    try {
        ...
        const result = await executeQuery(`INSERT INTO admin.sync_schedules (node_id, academic_year, cron_expression, endpoints_mb, endpoints_nex, include_descendants, created_by)
