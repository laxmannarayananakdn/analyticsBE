...
import { getAllTenantConfigs, createTenantConfig, updateTenantConfig, deleteTenantConfig, } from '../services/MicrosoftTenantService.js';
...
router.put('/:id', async (req, res) => {
    try {
        ...
        if (authorityTenant !== undefined)
            updates.authorityTenant = authorityTenant;
...
//# sourceMappingURL=microsoftTenantConfig.js.map