 ...
 */
router.get('/term-grade-rubric-config/schools', async (req, res) => {
    try {
        const query = `
 ...
 */
router.get('/term-grade-rubric-config', async (req, res) => {
    try {
 ...
 */
router.delete('/term-grade-rubric-config/:id', async (req, res) => {
    try {
...
//# sourceMappingURL=managebacConfig.js.map