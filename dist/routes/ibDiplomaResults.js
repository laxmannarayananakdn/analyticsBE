...
router.put('/', async (req, res) => {
    try {
            ...
            for (const row of updates) {
                ...
                if (hasResult) {
                    ...
                    if (raw == null || String(raw).trim() === '') {
                        ...
                        if (!RESULT_OPTIONS.includes(resultValue)) {
                            errorCount++;
                ...
                if (hasCategory) {
                    ...
                    if (raw == null || String(raw).trim() === '') {
                        ...
                        if (!IB_CATEGORY_OPTIONS.includes(categoryValue)) {
                            errorCount++;
        ...
        `);
                ...
                const setParts = ['updated_at = GETDATE()'];
...
//# sourceMappingURL=ibDiplomaResults.js.map