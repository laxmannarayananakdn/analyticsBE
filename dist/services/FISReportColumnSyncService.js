 ...
 */
export async function repairTrialBalanceEntityPeriodFromData() {
    const files = await executeQuery(`SELECT DISTINCT file_name FROM FIN.TrialBalance WHERE file_name LIKE 'TB[_]%'`);
    if (files.error)
