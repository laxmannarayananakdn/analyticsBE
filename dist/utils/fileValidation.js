 ...
 */
export function validateFileExtension(fileName, expectedExtension) {
 ...
 */
export function validateMimeType(mimeType, expectedExtension) {
    if (!mimeType) {
 ...
 */
export function validateRequiredColumns(headers, requiredColumns, columnMapping) {
 ...
 * Validate data type
 */
export function validateDataType(value, expectedType, column, row) {
